...
def currency_format(value, prefix: str = 'code', space: bool = True):
    ...
    if value is None or current_currency.exchange_rate is None or value == '' or current_currency.exchange_rate == '':
        value = 0
    ...
    formatted_value = formats.number_format(converted_value, decimal_pos=2, use_l10n=True, force_grouping=True)
