...
class Files:
    ...
    def createFiles(self):
        for fileType in FileType:
            ...
            if files is not NotImplemented and type(files) == FileMaker:
    ...
    def cssFile(self, file: str, version: int = 1, folder: Any = ThemeFolder.common, urlOnly: bool = False):
    ...
    def jsFile(self, file: str, version: int = 1, folder: Any = ThemeFolder.common, urlOnly: bool = False):
        ...
        return '<script src="{0}"></script>'.format('{% static ' + file + '.js?v=' + str(version) + ' %}')
